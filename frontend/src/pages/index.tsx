    ...
    <>
      <Container height="100vh">
        <Flex height="100vh" width="100vw" flexDirection={'column'} alignItems={'center'} justifyContent={'center'}>
          ...
          <Flex width={'60vw'} flexDirection={'column'} justifyContent={'flex-start'} marginBottom={'30px'}>
            <Button width={'150px'} height={'50px'} backgroundColor="#000" color={'#fff'} fontSize={'16px'} _hover={{ backgroundColor: "#0A0A0A" }} onClick={signUpAPI}> Registrar e entrar</Button>
          </Flex>
          <Flex width={'60vw'} flexDirection={'column'} justifyContent={'flex-start'} marginBottom={'30px'}>
            <Text color={'#555454'} fontSize={'16px'}> Já possui uma conta? <Link color='#000000' onClick={redirectToLogin}>Entre</Link> </Text>
          </Flex>
        </Flex>
      </Container> 
    </>
